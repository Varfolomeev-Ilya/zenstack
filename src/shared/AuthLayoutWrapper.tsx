...
const AuthLayoutWrapper: FC<IAuthLayoutWrapperProps> = ({ children }) => {
  return (
    <div className="w-full h-full flex flex-col gap-10 items-center lg:flex-row">
      ...
      <div className="flex flex-col items-center justify-center py-6 px-7 w-full">{children}</div>
    </div>
  );
};
